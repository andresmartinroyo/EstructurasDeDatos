...
public class ABB {
    ...
    */
    ...
    public int medirArbol(){
        if (!this.esVacio()){
        return medirArbol(this.getpRoot(), 1, 1);
    }else {
            return 0;
        }
    }
    public int medirArbol(NodoABB raiz, int acum, int ramamax){
        if (raiz.getLeft() == null && raiz.getRight() == null){
            ...
            if ( raiz.getLeft() != null ){
                ramamax = medirArbol(raiz.getLeft(),acum +1,ramamax);
            }
            if (raiz.getRight() != null){
                ramamax = medirArbol(raiz.getRight(),acum +1,ramamax);
            }
        }
        return ramamax;
    }
